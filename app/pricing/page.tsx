      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        <section className="rounded-3xl border border-[#c9d8ef] bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            {plans.map((plan) => (
              <article key={plan.name} className="rounded-2xl border border-[#c9d8ef] bg-[#f5f9ff] p-4">
          ...
          <div className="mt-5">
            <Link href="/contact" className="inline-flex items-center rounded-xl bg-[#142c4f] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1b355f]">
              Contact sales
            </Link>
          </div>
        </section>
